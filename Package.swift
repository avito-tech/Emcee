...
let package = Package(
    ...
    dependencies: [
        .package(name: "CommandLineToolkit", url: "https://github.com/avito-tech/CommandLineToolkit.git", .exact("1.0.11")),
    ...
    targets: [
        ...
        .testTarget(
            ...
            dependencies: [
                ...
                "MetricsExtensions",
                .product(name: "MetricsRecording", package: "CommandLineToolkit"),
