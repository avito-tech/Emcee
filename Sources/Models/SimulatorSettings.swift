...
public struct SimulatorSettings {
    /** Absolute path to JSON with localization settings for Simulator. These settings will be applied after simulator has been created and before it will be booted. */
